...
workflow.add_node("analyst", state_packer(nodes.llama_3_2_3_b_node))
...
workflow.add_node("fast_analyst", state_packer(nodes.qwen_3_1_7b_node))
...
workflow.add_edge("strategist", "fast_analyst")
workflow.add_edge("fast_analyst", "reporter")
